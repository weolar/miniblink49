...
void PromiseRejectCallback(PromiseRejectMessage message)
{
    ...
    v8::PromiseRejectEvent evt = message.GetEvent();
    Local<Integer> event = Integer::New(isolate, evt);

    bool needPrint = true;
#if V8_MAJOR_VERSION >= 7
    needPrint = v8::kPromiseRejectAfterResolved == evt || v8::kPromiseRejectWithNoHandler == evt;
#endif
    if (needPrint) {
