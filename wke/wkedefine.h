...
typedef void(WKE_CALL_TYPE* wkeNetCurlSetopt)(void* curlHandle, __int32 option, ...);
typedef void(WKE_CALL_TYPE* wkeOnNetCurlSetoptCallback)(void* curlHandle, wkeNetCurlSetopt setopt);
