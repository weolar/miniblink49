...
//////////////////////////////////////////////////////////////////////////
#define NONE_RUNTIME_FUNCTION(name) \
RUNTIME_FUNCTION(name) { \
    DebugBreak();        \
    return nullptr;      \
}

// NONE_RUNTIME_FUNCTION(Runtime_DeoptimizeFunction)
// NONE_RUNTIME_FUNCTION(Runtime_DeoptimizeNow)
// NONE_RUNTIME_FUNCTION(Runtime_RunningInSimulator)
// NONE_RUNTIME_FUNCTION(Runtime_IsConcurrentRecompilationSupported)
// NONE_RUNTIME_FUNCTION(Runtime_OptimizeFunctionOnNextCall)
// NONE_RUNTIME_FUNCTION(Runtime_OptimizeOsr)
// NONE_RUNTIME_FUNCTION(Runtime_NeverOptimizeFunction)
// NONE_RUNTIME_FUNCTION(Runtime_GetOptimizationStatus)
// NONE_RUNTIME_FUNCTION(Runtime_UnblockConcurrentRecompilation)
// NONE_RUNTIME_FUNCTION(Runtime_GetOptimizationCount)
// NONE_RUNTIME_FUNCTION(Runtime_GetUndetectable)
// NONE_RUNTIME_FUNCTION(Runtime_ClearFunctionTypeFeedback)
// NONE_RUNTIME_FUNCTION(Runtime_NotifyContextDisposed)
// NONE_RUNTIME_FUNCTION(Runtime_SetAllocationTimeout)
// NONE_RUNTIME_FUNCTION(Runtime_DebugPrint)
// NONE_RUNTIME_FUNCTION(Runtime_DebugTrace)
// NONE_RUNTIME_FUNCTION(Runtime_GlobalPrint)
// NONE_RUNTIME_FUNCTION(Runtime_SystemBreak)
// NONE_RUNTIME_FUNCTION(Runtime_SetFlags)
// NONE_RUNTIME_FUNCTION(Runtime_Abort)
// NONE_RUNTIME_FUNCTION(Runtime_AbortJS)
// NONE_RUNTIME_FUNCTION(Runtime_NativeScriptsCount)
// NONE_RUNTIME_FUNCTION(Runtime_GetV8Version)
// NONE_RUNTIME_FUNCTION(Runtime_DisassembleFunction)
// NONE_RUNTIME_FUNCTION(Runtime_TraceEnter)
// NONE_RUNTIME_FUNCTION(Runtime_TraceExit)
// NONE_RUNTIME_FUNCTION(Runtime_HaveSameMap)
// NONE_RUNTIME_FUNCTION(Runtime_HasFastSmiElements)
// NONE_RUNTIME_FUNCTION(Runtime_HasFastObjectElements)
// NONE_RUNTIME_FUNCTION(Runtime_HasFastSmiOrObjectElements)
// NONE_RUNTIME_FUNCTION(Runtime_HasFastDoubleElements)
// NONE_RUNTIME_FUNCTION(Runtime_HasFastHoleyElements)
// NONE_RUNTIME_FUNCTION(Runtime_HasDictionaryElements)
// NONE_RUNTIME_FUNCTION(Runtime_HasSloppyArgumentsElements)
// NONE_RUNTIME_FUNCTION(Runtime_HasExternalArrayElements)
// NONE_RUNTIME_FUNCTION(Runtime_HasFastProperties)
// NONE_RUNTIME_FUNCTION(Runtime_HasExternalUint8Elements)
// NONE_RUNTIME_FUNCTION(Runtime_HasExternalInt8Elements)
// NONE_RUNTIME_FUNCTION(Runtime_HasExternalUint16Elements)
// NONE_RUNTIME_FUNCTION(Runtime_HasExternalInt16Elements)
// NONE_RUNTIME_FUNCTION(Runtime_HasExternalUint32Elements)
// NONE_RUNTIME_FUNCTION(Runtime_HasExternalInt32Elements)
// NONE_RUNTIME_FUNCTION(Runtime_HasExternalFloat32Elements)
// NONE_RUNTIME_FUNCTION(Runtime_HasExternalFloat64Elements)
// NONE_RUNTIME_FUNCTION(Runtime_HasExternalUint8ClampedElements)
// NONE_RUNTIME_FUNCTION(Runtime_HasFixedUint8Elements)
// NONE_RUNTIME_FUNCTION(Runtime_HasFixedInt8Elements)
// NONE_RUNTIME_FUNCTION(Runtime_HasFixedUint16Elements)
// NONE_RUNTIME_FUNCTION(Runtime_HasFixedInt16Elements)
// NONE_RUNTIME_FUNCTION(Runtime_HasFixedUint32Elements)
// NONE_RUNTIME_FUNCTION(Runtime_HasFixedInt32Elements)
// NONE_RUNTIME_FUNCTION(Runtime_HasFixedFloat32Elements)
// NONE_RUNTIME_FUNCTION(Runtime_HasFixedFloat64Elements)
// NONE_RUNTIME_FUNCTION(Runtime_HasFixedUint8ClampedElements)
