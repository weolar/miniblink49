...
// #if USING_VC6RT == 1
//   void FormatParameter(std::ostream& os, uint32_t val) const { os << val; }
//   void FormatParameter(std::ostream& os, int val) const { os << val; }
//   void FormatParameter(std::ostream& os, float val) const { os << val; }
//   void FormatParameter(std::ostream& os, double val) const { os << val; }
// 
//   void FormatParameter(std::ostream& os, __int64 val) const {
//     char buf[32];
...
//   }
// 
//   void FormatParameter(std::ostream& os, const void *const val) const { os << val; }
//   void FormatParameter(std::ostream& os, const v8::internal::compiler::FrameStateInfo& val) const { os << val; }
//   void FormatParameter(std::ostream& os, const v8::internal::compiler::SelectParameters& val) const { os << val; }
//   void FormatParameter(std::ostream& os, const v8::internal::Unique<v8::internal::HeapObject>& val) const { os << val; }
//   void FormatParameter(std::ostream& os, const v8::internal::ExternalReference& val) const { os << val; }
//   void FormatParameter(std::ostream& os, const v8::internal::compiler::ParameterInfo& val) const { os << val; }
//   void FormatParameter(std::ostream& os, const v8::internal::compiler::BranchHint& val) const { os << val; }
//   void FormatParameter(std::ostream& os, const v8::internal::compiler::IfExceptionHint& val) const { os << val; }
// #endif

  virtual void PrintParameter(std::ostream& os) const {
// #if USING_VC6RT == 1
//     os << "[";
//     FormatParameter(os, this->parameter());
//     os << "]";
// #else
    os << "[" << this->parameter() << "]";
// #endif
