...
CEF_EXPORT int cef_execute_process(const cef_main_args_t* args, cef_app_t* application, void* windowsSandboxInfo) {
    if (!application)
        return 0;
    ...
    return CefExecuteProcess(argsObj, CefAppCToCpp::Wrap(application), windowsSandboxInfo);
}

CEF_EXPORT int cef_initialize(const cef_main_args_t* args, const cef_settings_t* settings, cef_app_t* application,
    ...
    return CefInitialize(argsObj, settingsObj, CefAppCToCpp::Wrap(application), windowsSandboxInfo);
}
