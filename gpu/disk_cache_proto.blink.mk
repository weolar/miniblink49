...
GYP_TARGET_DEPENDENCIES := \
	$(LOCAL_PATH)/$(gyp_shared_intermediate_dir)/protoc
...
GYP_GENERATED_OUTPUTS := \
	$(LOCAL_PATH)/$(gyp_shared_intermediate_dir)/pyproto/gpu/command_buffer/service/disk_cache_proto_pb2.py \
	$(LOCAL_PATH)/$(gyp_shared_intermediate_dir)/protoc_out/gpu/command_buffer/service/disk_cache_proto.pb.cc \
	$(LOCAL_PATH)/$(gyp_shared_intermediate_dir)/protoc_out/gpu/command_buffer/service/disk_cache_proto.pb.h
...
#//	$(LOCAL_PATH)/$(gyp_intermediate_dir)/disk_cache_proto.pb.cc \
#//	$(LOCAL_PATH)/$(gyp_shared_intermediate_dir)/pyproto/gpu/command_buffer/service/disk_cache_proto_pb2.py \
#//	$(LOCAL_PATH)/$(gyp_shared_intermediate_dir)/protoc_out/gpu/command_buffer/service/disk_cache_proto.pb.h

GYP_COPIED_SOURCE_ORIGIN_DIRS := \
	$(LOCAL_PATH)/$(gyp_shared_intermediate_dir)/protoc_out/gpu/command_buffer/service

LOCAL_SRC_FILES := gen/protoc_out/gpu/command_buffer/service/disk_cache_proto.pb.cc
