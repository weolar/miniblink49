...
const PROPERTYKEY PKEY_AppUserModel_IsDualMode = { { 0x9F4C2855, 0x9F79, 0x4B39, { 0xA8, 0xD0, 0xE1, 0xD4, 0x2D, 0xE1, 0xD5, 0xF3 } }, 11 };
...
bool CreateOrUpdateShortcutLink(const FilePath& shortcut_path, const ShortcutProperties& properties, ShortcutOperation operation)
{
    ...
    static int isGreaterWin7 = -1;
    if (-1 == isGreaterWin7) {
        HMODULE kernel32 = GetModuleHandle(L"KERNEL32.DLL");
        isGreaterWin7 = !!GetProcAddress(kernel32, "WakeConditionVariable") ? 1 : 0;
    }

    if ((has_app_id || has_dual_mode) && isGreaterWin7) {
