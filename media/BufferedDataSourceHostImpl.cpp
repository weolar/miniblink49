...
static base::TimeDelta TimeForByteOffset(int64 byte_offset, int64 total_bytes, base::TimeDelta duration) 
{
    ...
    if (position > 0.99)
        return duration;
    return base::TimeDelta::FromMilliseconds(static_cast<int64>(position * duration.InMilliseconds()));
}

void BufferedDataSourceHostImpl::AddBufferedTimeRanges(Ranges<base::TimeDelta>* buffered_time_ranges, base::TimeDelta media_duration) const
{
