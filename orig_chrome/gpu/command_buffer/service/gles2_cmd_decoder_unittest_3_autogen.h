...
TEST_P(GLES2DecoderTest3, UniformMatrix2x4fvImmediateValidArgs)
{
    ...
    EXPECT_CALL(*gl_,
        UniformMatrix2x4fv(1, 2, false, reinterpret_cast<GLfloat*>(ImmediateDataAddress(&cmd))));
...
TEST_P(GLES2DecoderTest3, UniformMatrix3fvImmediateValidArgs)
{
    ...
    EXPECT_CALL(*gl_,
        UniformMatrix3fv(1, 2, false, reinterpret_cast<GLfloat*>(ImmediateDataAddress(&cmd))));
...
TEST_P(GLES2DecoderTest3, UniformMatrix3x2fvImmediateValidArgs)
{
    ...
    EXPECT_CALL(*gl_,
        UniformMatrix3x2fv(1, 2, false, reinterpret_cast<GLfloat*>(ImmediateDataAddress(&cmd))));
...
TEST_P(GLES2DecoderTest3, UniformMatrix3x4fvImmediateValidArgs)
{
    ...
    EXPECT_CALL(*gl_,
        UniformMatrix3x4fv(1, 2, false, reinterpret_cast<GLfloat*>(ImmediateDataAddress(&cmd))));
...
TEST_P(GLES2DecoderTest3, UniformMatrix4fvImmediateValidArgs)
{
    ...
    EXPECT_CALL(*gl_,
        UniformMatrix4fv(1, 2, false, reinterpret_cast<GLfloat*>(ImmediateDataAddress(&cmd))));
...
TEST_P(GLES2DecoderTest3, UniformMatrix4x2fvImmediateValidArgs)
{
    ...
    EXPECT_CALL(*gl_,
        UniformMatrix4x2fv(1, 2, false, reinterpret_cast<GLfloat*>(ImmediateDataAddress(&cmd))));
...
TEST_P(GLES2DecoderTest3, UniformMatrix4x3fvImmediateValidArgs)
{
    ...
    EXPECT_CALL(*gl_,
        UniformMatrix4x3fv(1, 2, false, reinterpret_cast<GLfloat*>(ImmediateDataAddress(&cmd))));
...
TEST_P(GLES2DecoderTest3, VertexAttrib1fvImmediateValidArgs)
{
    ...
    cmd.Init(1, &temp[0]);
    EXPECT_CALL(*gl_, VertexAttrib1fv(1, reinterpret_cast<GLfloat*>(ImmediateDataAddress(&cmd))));
    EXPECT_EQ(error::kNoError, ExecuteImmediateCmd(cmd, sizeof(temp)));
    EXPECT_EQ(GL_NO_ERROR, GetGLError());
}
...
TEST_P(GLES2DecoderTest3, VertexAttrib2fvImmediateValidArgs)
{
    ...
    cmd.Init(1, &temp[0]);
    EXPECT_CALL(*gl_, VertexAttrib2fv(1, reinterpret_cast<GLfloat*>(ImmediateDataAddress(&cmd))));
    EXPECT_EQ(error::kNoError, ExecuteImmediateCmd(cmd, sizeof(temp)));
    EXPECT_EQ(GL_NO_ERROR, GetGLError());
}
...
TEST_P(GLES2DecoderTest3, VertexAttrib3fvImmediateValidArgs)
{
    ...
    cmd.Init(1, &temp[0]);
    EXPECT_CALL(*gl_, VertexAttrib3fv(1, reinterpret_cast<GLfloat*>(ImmediateDataAddress(&cmd))));
    EXPECT_EQ(error::kNoError, ExecuteImmediateCmd(cmd, sizeof(temp)));
    EXPECT_EQ(GL_NO_ERROR, GetGLError());
}
...
TEST_P(GLES2DecoderTest3, VertexAttrib4fvImmediateValidArgs)
{
    ...
    cmd.Init(1, &temp[0]);
    EXPECT_CALL(*gl_, VertexAttrib4fv(1, reinterpret_cast<GLfloat*>(ImmediateDataAddress(&cmd))));
    EXPECT_EQ(error::kNoError, ExecuteImmediateCmd(cmd, sizeof(temp)));
    EXPECT_EQ(GL_NO_ERROR, GetGLError());
}
...
TEST_P(GLES2DecoderTest3, VertexAttribI4ivImmediateValidArgs)
{
    ...
    cmd.Init(1, &temp[0]);
    EXPECT_CALL(*gl_, VertexAttribI4iv(1, reinterpret_cast<GLint*>(ImmediateDataAddress(&cmd))));
    decoder_->set_unsafe_es3_apis_enabled(true);
    EXPECT_EQ(error::kNoError, ExecuteImmediateCmd(cmd, sizeof(temp)));
    EXPECT_EQ(GL_NO_ERROR, GetGLError());
    decoder_->set_unsafe_es3_apis_enabled(false);
...
TEST_P(GLES2DecoderTest3, VertexAttribI4uivImmediateValidArgs)
{
    ...
    cmd.Init(1, &temp[0]);
    EXPECT_CALL(*gl_, VertexAttribI4uiv(1, reinterpret_cast<GLuint*>(ImmediateDataAddress(&cmd))));
    decoder_->set_unsafe_es3_apis_enabled(true);
    EXPECT_EQ(error::kNoError, ExecuteImmediateCmd(cmd, sizeof(temp)));
    EXPECT_EQ(GL_NO_ERROR, GetGLError());
    decoder_->set_unsafe_es3_apis_enabled(false);
