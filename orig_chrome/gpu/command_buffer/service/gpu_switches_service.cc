...
const char kEnableShareGroupAsyncTextureUpload[] = "enable-share-group-async-texture-upload";

// Enable WebGL subscribe uniform extension.
const char kEnableSubscribeUniformExtension[] = "enable-subscribe-uniform-extension";
