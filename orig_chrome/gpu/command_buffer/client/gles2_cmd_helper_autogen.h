...
void TexImageIOSurface2DCHROMIUM(GLenum target,
    ...
    GLuint plane)
{
    gles2::cmds::TexImageIOSurface2DCHROMIUM* c = GetCmdSpace<gles2::cmds::TexImageIOSurface2DCHROMIUM>();
    if (c) {
...
void CompressedCopySubTextureCHROMIUM(GLenum target,
    ...
    GLsizei height)
{
    gles2::cmds::CompressedCopySubTextureCHROMIUM* c = GetCmdSpace<gles2::cmds::CompressedCopySubTextureCHROMIUM>();
    if (c) {
        c->Init(target, source_id, dest_id, xoffset, yoffset, x, y, width, height);
    }
}
...
{
    const uint32_t size = gles2::cmds::GenValuebuffersCHROMIUMImmediate::ComputeSize(n);
    gles2::cmds::GenValuebuffersCHROMIUMImmediate* c = GetImmediateCmdSpaceTotalSize<
...
{
    const uint32_t size = gles2::cmds::DeleteValuebuffersCHROMIUMImmediate::ComputeSize(n);
    gles2::cmds::DeleteValuebuffersCHROMIUMImmediate* c = GetImmediateCmdSpaceTotalSize<
...
void IsValuebufferCHROMIUM(GLuint valuebuffer,
    ...
    uint32_t result_shm_offset)
{
    gles2::cmds::IsValuebufferCHROMIUM* c = GetCmdSpace<gles2::cmds::IsValuebufferCHROMIUM>();
    if (c) {
...
{
    gles2::cmds::BindValuebufferCHROMIUM* c = GetCmdSpace<gles2::cmds::BindValuebufferCHROMIUM>();
    if (c) {
...
{
    gles2::cmds::SubscribeValueCHROMIUM* c = GetCmdSpace<gles2::cmds::SubscribeValueCHROMIUM>();
    if (c) {
...
{
    gles2::cmds::PopulateSubscribedValuesCHROMIUM* c = GetCmdSpace<gles2::cmds::PopulateSubscribedValuesCHROMIUM>();
    if (c) {
        c->Init(target);
    }
}
...
void UniformValuebufferCHROMIUM(GLint location,
    ...
    GLenum subscription)
{
    gles2::cmds::UniformValuebufferCHROMIUM* c = GetCmdSpace<gles2::cmds::UniformValuebufferCHROMIUM>();
    if (c) {
...
{
    gles2::cmds::WaitSyncPointCHROMIUM* c = GetCmdSpace<gles2::cmds::WaitSyncPointCHROMIUM>();
    if (c) {
        c->Init(sync_point);
    }
}
