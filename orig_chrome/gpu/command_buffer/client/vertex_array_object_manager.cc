        ...
        bool* simulated)
    {
        ...
        *simulated = true;
        ...
        for (GLuint ii = 0; ii < vertex_attribs.size(); ++ii) {
            ...
            if (attrib.IsClientSide() && attrib.enabled()) {
                size_t bytes_per_element = GLES2Util::GetGLTypeSizeForTexturesAndBuffers(attrib.type()) * attrib.size();
        ...
        *offset = ToGLuint(indices);
        ...
        if (bound_vertex_array_object_->bound_element_array_buffer() == 0) {
            ...
            *offset = 0;
            ...
            GLsizei bytes_per_element = GLES2Util::GetGLTypeSizeForTexturesAndBuffers(type);
