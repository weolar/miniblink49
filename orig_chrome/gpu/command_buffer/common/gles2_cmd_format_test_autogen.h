...
TEST_F(GLES2FormatTest, BufferData)
{
    ...
    void* next_cmd = cmd.Set(&cmd, static_cast<GLenum>(11), static_cast<GLsizeiptr>(12),
...
TEST_F(GLES2FormatTest, BufferSubData)
{
    ...
    void* next_cmd = cmd.Set(&cmd, static_cast<GLenum>(11), static_cast<GLintptr>(12),
...
TEST_F(GLES2FormatTest, ClientWaitSync)
{
    ...
    void* next_cmd = cmd.Set(&cmd, static_cast<GLuint>(11), static_cast<GLbitfield>(12),
...
TEST_F(GLES2FormatTest, ColorMask)
{
    ...
    void* next_cmd = cmd.Set(&cmd, static_cast<GLboolean>(11), static_cast<GLboolean>(12),
...
TEST_F(GLES2FormatTest, DrawElements)
{
    ...
    void* next_cmd = cmd.Set(&cmd, static_cast<GLenum>(11), static_cast<GLsizei>(12),
...
TEST_F(GLES2FormatTest, GetUniformfv)
{
    ...
    void* next_cmd = cmd.Set(&cmd, static_cast<GLuint>(11), static_cast<GLint>(12),
        static_cast<uint32_t>(13), static_cast<uint32_t>(14));
...
TEST_F(GLES2FormatTest, GetMaxValueInBufferCHROMIUM)
{
    ...
    void* next_cmd = cmd.Set(&cmd, static_cast<GLuint>(11), static_cast<GLsizei>(12),
        static_cast<GLenum>(13), static_cast<GLuint>(14),
        static_cast<uint32_t>(15), static_cast<uint32_t>(16));
...
{
    cmds::PostSubBufferCHROMIUM& cmd = *GetBufferAs<cmds::PostSubBufferCHROMIUM>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLint>(11), static_cast<GLint>(12),
        static_cast<GLint>(13), static_cast<GLint>(14));
...
{
    cmds::TexImageIOSurface2DCHROMIUM& cmd = *GetBufferAs<cmds::TexImageIOSurface2DCHROMIUM>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLenum>(11),
...
{
    cmds::CompressedCopyTextureCHROMIUM& cmd = *GetBufferAs<cmds::CompressedCopyTextureCHROMIUM>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLenum>(11),
        static_cast<GLenum>(12), static_cast<GLenum>(13));
...
{
    cmds::CompressedCopySubTextureCHROMIUM& cmd = *GetBufferAs<cmds::CompressedCopySubTextureCHROMIUM>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLenum>(11),
        static_cast<GLenum>(12), static_cast<GLenum>(13),
        static_cast<GLint>(14), static_cast<GLint>(15),
        static_cast<GLint>(16), static_cast<GLint>(17),
...
TEST_F(GLES2FormatTest, ProduceTextureCHROMIUMImmediate)
{
    ...
    cmds::ProduceTextureCHROMIUMImmediate& cmd = *GetBufferAs<cmds::ProduceTextureCHROMIUMImmediate>();
...
TEST_F(GLES2FormatTest, ConsumeTextureCHROMIUMImmediate)
{
    ...
    cmds::ConsumeTextureCHROMIUMImmediate& cmd = *GetBufferAs<cmds::ConsumeTextureCHROMIUMImmediate>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLenum>(11), data);
    EXPECT_EQ(
...
TEST_F(GLES2FormatTest, GenValuebuffersCHROMIUMImmediate)
{
    ...
    cmds::GenValuebuffersCHROMIUMImmediate& cmd = *GetBufferAs<cmds::GenValuebuffersCHROMIUMImmediate>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLsizei>(arraysize(ids)), ids);
    EXPECT_EQ(
...
TEST_F(GLES2FormatTest, DeleteValuebuffersCHROMIUMImmediate)
{
    ...
    cmds::DeleteValuebuffersCHROMIUMImmediate& cmd = *GetBufferAs<cmds::DeleteValuebuffersCHROMIUMImmediate>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLsizei>(arraysize(ids)), ids);
    EXPECT_EQ(
...
{
    cmds::IsValuebufferCHROMIUM& cmd = *GetBufferAs<cmds::IsValuebufferCHROMIUM>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLuint>(11), static_cast<uint32_t>(12),
        static_cast<uint32_t>(13));
...
{
    cmds::BindValuebufferCHROMIUM& cmd = *GetBufferAs<cmds::BindValuebufferCHROMIUM>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLenum>(11), static_cast<GLuint>(12));
...
{
    cmds::SubscribeValueCHROMIUM& cmd = *GetBufferAs<cmds::SubscribeValueCHROMIUM>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLenum>(11), static_cast<GLenum>(12));
...
{
    cmds::PopulateSubscribedValuesCHROMIUM& cmd = *GetBufferAs<cmds::PopulateSubscribedValuesCHROMIUM>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLenum>(11));
    EXPECT_EQ(
...
{
    cmds::UniformValuebufferCHROMIUM& cmd = *GetBufferAs<cmds::UniformValuebufferCHROMIUM>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLint>(11),
        static_cast<GLenum>(12), static_cast<GLenum>(13));
...
{
    cmds::BindTexImage2DCHROMIUM& cmd = *GetBufferAs<cmds::BindTexImage2DCHROMIUM>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLenum>(11), static_cast<GLint>(12));
...
{
    cmds::ReleaseTexImage2DCHROMIUM& cmd = *GetBufferAs<cmds::ReleaseTexImage2DCHROMIUM>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLenum>(11), static_cast<GLint>(12));
...
{
    cmds::WaitSyncPointCHROMIUM& cmd = *GetBufferAs<cmds::WaitSyncPointCHROMIUM>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLuint>(11));
...
{
    cmds::ScheduleOverlayPlaneCHROMIUM& cmd = *GetBufferAs<cmds::ScheduleOverlayPlaneCHROMIUM>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLint>(11),
        static_cast<GLenum>(12), static_cast<GLuint>(13),
        static_cast<GLint>(14), static_cast<GLint>(15),
        static_cast<GLint>(16), static_cast<GLint>(17),
...
TEST_F(GLES2FormatTest, MatrixLoadfCHROMIUMImmediate)
{
    ...
    cmds::MatrixLoadfCHROMIUMImmediate& cmd = *GetBufferAs<cmds::MatrixLoadfCHROMIUMImmediate>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLenum>(11), data);
...
{
    cmds::MatrixLoadIdentityCHROMIUM& cmd = *GetBufferAs<cmds::MatrixLoadIdentityCHROMIUM>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLenum>(11));
...
{
    cmds::PathParameterfCHROMIUM& cmd = *GetBufferAs<cmds::PathParameterfCHROMIUM>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLuint>(11),
        static_cast<GLenum>(12), static_cast<GLfloat>(13));
...
{
    cmds::PathParameteriCHROMIUM& cmd = *GetBufferAs<cmds::PathParameteriCHROMIUM>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLuint>(11),
        static_cast<GLenum>(12), static_cast<GLint>(13));
...
{
    cmds::PathStencilFuncCHROMIUM& cmd = *GetBufferAs<cmds::PathStencilFuncCHROMIUM>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLenum>(11),
        static_cast<GLint>(12), static_cast<GLuint>(13));
...
{
    cmds::StencilFillPathCHROMIUM& cmd = *GetBufferAs<cmds::StencilFillPathCHROMIUM>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLuint>(11),
        static_cast<GLenum>(12), static_cast<GLuint>(13));
...
{
    cmds::StencilStrokePathCHROMIUM& cmd = *GetBufferAs<cmds::StencilStrokePathCHROMIUM>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLuint>(11),
        static_cast<GLint>(12), static_cast<GLuint>(13));
...
{
    cmds::CoverFillPathCHROMIUM& cmd = *GetBufferAs<cmds::CoverFillPathCHROMIUM>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLuint>(11), static_cast<GLenum>(12));
...
{
    cmds::CoverStrokePathCHROMIUM& cmd = *GetBufferAs<cmds::CoverStrokePathCHROMIUM>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLuint>(11), static_cast<GLenum>(12));
...
{
    cmds::StencilThenCoverFillPathCHROMIUM& cmd = *GetBufferAs<cmds::StencilThenCoverFillPathCHROMIUM>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLuint>(11), static_cast<GLenum>(12),
...
{
    cmds::StencilThenCoverStrokePathCHROMIUM& cmd = *GetBufferAs<cmds::StencilThenCoverStrokePathCHROMIUM>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLuint>(11), static_cast<GLint>(12),
        static_cast<GLuint>(13), static_cast<GLenum>(14));
    EXPECT_EQ(
...
{
    cmds::ApplyScreenSpaceAntialiasingCHROMIUM& cmd = *GetBufferAs<cmds::ApplyScreenSpaceAntialiasingCHROMIUM>();
    void* next_cmd = cmd.Set(&cmd);
    EXPECT_EQ(
