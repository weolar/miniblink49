...
static_assert(offsetof(StencilStrokePathInstancedCHROMIUM, paths_shm_offset) == 16,
...
static_assert(offsetof(StencilThenCoverFillPathInstancedCHROMIUM, pathBase) == 20,
    "offset of StencilThenCoverFillPathInstancedCHROMIUM pathBase "
    "should be 20");
static_assert(offsetof(StencilThenCoverFillPathInstancedCHROMIUM, fillMode) == 24,
...
static_assert(offsetof(StencilThenCoverFillPathInstancedCHROMIUM, coverMode) == 32,
...
static_assert(offsetof(StencilThenCoverStrokePathInstancedCHROMIUM, numPaths) == 4,
...
static_assert(offsetof(StencilThenCoverStrokePathInstancedCHROMIUM,
    ...
    "offset of StencilThenCoverStrokePathInstancedCHROMIUM "
    "paths_shm_offset should be 16");
static_assert(offsetof(StencilThenCoverStrokePathInstancedCHROMIUM, pathBase) == 20,
