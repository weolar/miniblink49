...
void DriverGLX::InitializeStaticBindings()
{
    ...
    fn.glXGetCurrentReadDrawableFn = reinterpret_cast<glXGetCurrentReadDrawableProc>(
    ...
    fn.glXGetVisualFromFBConfigFn = reinterpret_cast<glXGetVisualFromFBConfigProc>(
    ...
    fn.glXQueryExtensionsStringFn = reinterpret_cast<glXQueryExtensionsStringProc>(
...
void DriverGLX::InitializeExtensionBindings()
{
    ...
    ext.b_GLX_ARB_create_context = extensions.find("GLX_ARB_create_context ") != std::string::npos;
    ext.b_GLX_EXT_swap_control = extensions.find("GLX_EXT_swap_control ") != std::string::npos;
    ext.b_GLX_EXT_texture_from_pixmap = extensions.find("GLX_EXT_texture_from_pixmap ") != std::string::npos;
    ext.b_GLX_MESA_copy_sub_buffer = extensions.find("GLX_MESA_copy_sub_buffer ") != std::string::npos;
    ext.b_GLX_MESA_swap_control = extensions.find("GLX_MESA_swap_control ") != std::string::npos;
    ext.b_GLX_OML_sync_control = extensions.find("GLX_OML_sync_control ") != std::string::npos;
    ext.b_GLX_SGIX_fbconfig = extensions.find("GLX_SGIX_fbconfig ") != std::string::npos;
    ext.b_GLX_SGI_video_sync = extensions.find("GLX_SGI_video_sync ") != std::string::npos;
    ...
    if (ext.b_GLX_ARB_create_context) {
        fn.glXCreateContextAttribsARBFn = reinterpret_cast<glXCreateContextAttribsARBProc>(
            GetGLProcAddress("glXCreateContextAttribsARB"));
    }

    debug_fn.glXGetFBConfigFromVisualSGIXFn = 0;
    if (ext.b_GLX_SGIX_fbconfig) {
        fn.glXGetFBConfigFromVisualSGIXFn = reinterpret_cast<glXGetFBConfigFromVisualSGIXProc>(
