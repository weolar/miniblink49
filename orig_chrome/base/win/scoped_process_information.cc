...
namespace win {
    ...
    namespace {
        ...
        bool CheckAndDuplicateHandle(HANDLE source, ScopedHandle* target)
        {
            ...
            if (base::win::GetVersion() == base::win::VERSION_WIN8 || base::win::GetVersion() == base::win::VERSION_WIN8_1) {
                ...
                NtDuplicateObject nt_duplicate_object = reinterpret_cast<NtDuplicateObject>(::GetProcAddress(
                ...
                if (nt_duplicate_object != NULL) {
                    ...
                    if (status < 0) {
                        ...
                        RtlNtStatusToDosError ntstatus_to_doserror = reinterpret_cast<RtlNtStatusToDosError>(::GetProcAddress(
