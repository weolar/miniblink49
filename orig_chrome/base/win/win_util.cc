...
namespace win {
    ...
    namespace {
        ...
        typedef BOOL(WINAPI* GetProcessMitigationPolicyType)(HANDLE hProcess, int MitigationPolicy, PVOID lpBuffer, SIZE_T dwLength);

#define kProcessSystemCallDisablePolicy 4
        ...
        private:
            static bool IsWin32kSyscallsDisabled()
            {
                ...
                if (get_process_mitigation_policy_func(GetCurrentProcess(),
                        kProcessSystemCallDisablePolicy,
        ...
        const wchar_t kWindows8OSKRegPath[] = L"Software\\Classes\\CLSID\\{054AAE20-4BEA-4347-8A35-64A533254A9D}"
                                              L"\\LocalServer32";
...
#define SM_CONVERTIBLESLATEMODE 0x2003
    ...
    bool IsTabletDevice()
    {
        ...
        //     slate_power_profile = (role == 8); // PlatformRoleSlate
        //
    ...
    enum DomainEnrollementState { UNKNOWN = -1,
        NOT_ENROLLED,
        ENROLLED };
