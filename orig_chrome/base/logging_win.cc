...
// }
//
// LogMessage::LogMessage(const char* file, int line, LogSeverity severity) : line_(0) {
//   DebugBreak();
// }
//
// // Used for CHECK().  Implied severity = LOG_FATAL.
// LogMessage::LogMessage(const char* file, int line, const char* condition) : line_(0) {
//   DebugBreak();
// }
//
// // Used for CHECK_EQ(), etc. Takes ownership of the given string.
// // Implied severity = LOG_FATAL.
// LogMessage::LogMessage(const char* file, int line, std::string* result) : line_(0) {
//   DebugBreak();
// }
//
// // Used for DCHECK_EQ(), etc. Takes ownership of the given string.
// LogMessage::LogMessage(const char* file, int line, LogSeverity severity, std::string* result) : line_(0) {
//   DebugBreak();
// }
//
// std::string* MakeCheckOpString<int, int>(const int&, const int&, const char* names) {
//   DebugBreak();
//   return nullptr;
// }
//
