...
namespace {
    ...
    public:
        ...
        void RunWork(uint32 additional_file_flags)
        {
            ...
            uint32 file_flags = File::FLAG_WRITE | File::FLAG_TEMPORARY | File::FLAG_CREATE_ALWAYS | additional_file_flags;
    ...
    const WriteCallback& callback)
{
    ...
    WriteHelper* helper = new WriteHelper(this, file_.Pass(), buffer, bytes_to_write);
    return task_runner_->PostTaskAndReply(
        FROM_HERE,
