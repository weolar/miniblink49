...
// does.
#if __cplusplus >= 201103 && !defined(OS_ANDROID) && !defined(OS_MACOSX) && !defined(OS_IOS) && !(defined(__clang__) && defined(OS_WIN))
                COMPILE_ASSERT(kSSizeMaxConst == static_cast<size_t>(std::numeric_limits<ssize_t>::max()),
