...
void** ConstructTlsVector()
{
    ...
    if (key == PlatformThreadLocalStorage::TLS_KEY_OUT_OF_INDEXES) {
        ...
        if (PlatformThreadLocalStorage::TLS_KEY_OUT_OF_INDEXES != base::subtle::NoBarrier_CompareAndSwap(&g_native_tls_key, PlatformThreadLocalStorage::TLS_KEY_OUT_OF_INDEXES, key)) {
