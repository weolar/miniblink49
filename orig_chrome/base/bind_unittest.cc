...
namespace {
    ...
    TEST_F(BindTest, FunctionTypeSupport)
    {
        ...
        Callback<NoRef*(void)> normal_non_refcounted_cb = Bind(&PolymorphicIdentity<NoRef*>, &no_ref_);
        normal_cb.Run();
    ...
    TEST_F(BindTest, ReturnValues)
    {
        ...
        Callback<int(void)> const_method_nonconst_obj_cb = Bind(&HasRef::IntConstMethod0, &has_ref_);
        Callback<int(void)> const_method_const_obj_cb = Bind(&HasRef::IntConstMethod0, const_has_ref_ptr_);
    ...
    TEST_F(BindTest, IgnoreResult)
    {
        ...
        Closure non_void_method_cb = Bind(IgnoreResult(&HasRef::IntMethod0), &has_ref_);
        non_void_method_cb.Run();

        Closure non_void_const_method_cb = Bind(IgnoreResult(&HasRef::IntConstMethod0), &has_ref_);
        ...
        Closure non_void_weak_method_cb = Bind(IgnoreResult(&NoRef::IntMethod0), weak_factory.GetWeakPtr());
        non_void_weak_method_cb.Run();

        Closure non_void_weak_const_method_cb = Bind(IgnoreResult(&NoRef::IntConstMethod0), weak_factory.GetWeakPtr());
    ...
    TEST_F(BindTest, ArgumentBinding)
    {
        ...
        Callback<IncompleteType*(void)> bind_incomplete_ptr_cb = Bind(&PolymorphicIdentity<IncompleteType*>, incomplete_ptr);
    ...
    TEST_F(BindTest, Unretained)
    {
        ...
        Callback<void(void)> method_cb = Bind(&NoRef::VoidMethod0, Unretained(&no_ref_));
        method_cb.Run();

        Callback<void(void)> const_method_cb = Bind(&NoRef::VoidConstMethod0, Unretained(&no_ref_));
        const_method_cb.Run();

        Callback<void(void)> const_method_const_ptr_cb = Bind(&NoRef::VoidConstMethod0, Unretained(const_no_ref_ptr_));
    ...
    TEST_F(BindTest, WeakPtr)
    {
        ...
        Closure const_method_cb = Bind(&NoRef::VoidConstMethod0, const_weak_factory.GetWeakPtr());
        const_method_cb.Run();

        Closure const_method_const_ptr_cb = Bind(&NoRef::VoidConstMethod0, const_weak_factory.GetWeakPtr());
        const_method_const_ptr_cb.Run();
    ...
    TEST_F(BindTest, ScopedRefptr)
    {
        ...
        Callback<int(void)> scoped_refptr_const_ref_cb = Bind(&FunctionWithScopedRefptrFirstParam, base::ConstRef(refptr), 1);
    ...
    TEST_F(BindTest, Owned)
    {
        ...
        Callback<DeleteCounter*(void)> no_capture_cb = Bind(&PolymorphicIdentity<DeleteCounter*>, Owned(counter));
        ...
        base::Closure own_object_cb = Bind(&DeleteCounter::VoidMethod0, Owned(counter));
        own_object_cb.Run();
        EXPECT_EQ(0, deletes);
        own_object_cb.Reset();
        EXPECT_EQ(1, deletes);
    ...
    TEST_F(BindTest, ScopedPtr)
    {
        ...
        Callback<scoped_ptr<DeleteCounter>(void)> unused_callback = Bind(&PassThru<scoped_ptr<DeleteCounter>>, Passed(&ptr));
        ...
        deletes = 0;
        DeleteCounter* counter = new DeleteCounter(&deletes);
        Callback<scoped_ptr<DeleteCounter>(void)> callback = Bind(&PassThru<scoped_ptr<DeleteCounter>>,
        ...
        Callback<scoped_ptr<DeleteCounter>(scoped_ptr<DeleteCounter>)> cb_unbound = Bind(&PassThru<scoped_ptr<DeleteCounter>>);
