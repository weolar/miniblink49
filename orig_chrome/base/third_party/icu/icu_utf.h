...
#define CBU_IS_UNICODE_NONCHAR(c) \
    ((c) >= 0xfdd0 && ((uint32)(c) <= 0xfdef || ((c)&0xfffe) == 0xfffe) && (uint32)(c) <= 0x10ffff)
...
#define CBU_IS_UNICODE_CHAR(c) \
    ((uint32)(c) < 0xd800 || ((uint32)(c) > 0xdfff && (uint32)(c) <= 0x10ffff && !CBU_IS_UNICODE_NONCHAR(c)))
...
#define CBU8_LENGTH(c) \
    ((uint32)(c) <= 0x7f ? 1 : ((uint32)(c) <= 0x7ff ? 2 : ((uint32)(c) <= 0xd7ff ? 3 : ((uint32)(c) <= 0xdfff || (uint32)(c) > 0x10ffff ? 0 : ((uint32)(c) <= 0xffff ? 3 : 4)))))
