...
namespace test {
    ...
    void RunTest_PostTask(MessagePumpFactory factory)
    {
        ...
        MessageLoop::current()->PostTask(FROM_HERE, Bind(&Foo::Test0, foo.get()));
        MessageLoop::current()->PostTask(FROM_HERE, Bind(&Foo::Test1ConstRef, foo.get(), a));
        MessageLoop::current()->PostTask(FROM_HERE, Bind(&Foo::Test1Ptr, foo.get(), &b));
        MessageLoop::current()->PostTask(FROM_HERE, Bind(&Foo::Test1Int, foo.get(), 100));
        MessageLoop::current()->PostTask(FROM_HERE, Bind(&Foo::Test2Ptr, foo.get(), &a, &c));
        MessageLoop::current()->PostTask(FROM_HERE, Bind(&Foo::Test2Mixed, foo.get(), a, &d));
