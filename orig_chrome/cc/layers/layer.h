...
#ifndef NOT_QB_BUILD
CC_EXPORT gfx::Size* GetThreadLocalSize();
CC_EXPORT void SetThreadLocalSize(scoped_ptr<gfx::Size> size);
#endif
...
public:
    ...
    {
        return replica_layer_.get() && (mask_layer_.get() || replica_layer_->mask_layer_.get());
    }
