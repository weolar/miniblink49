...

{
  'variables': {
    'conditions': [
      #['OS == "win" and target_arch == "ia32" and ffmpeg_branding == "Chromium"', {
      #  'c_sources': [
      #    'libavcodec/x86/h264dsp_init_1.c',
      #  ],
      #}],
      #
      #['OS == "win" and target_arch == "ia32" and ffmpeg_branding == "Chrome"', {
      #  'c_sources': [
      #    'libavcodec/x86/h264dsp_init_2.c',
      #  ],
      #}],
