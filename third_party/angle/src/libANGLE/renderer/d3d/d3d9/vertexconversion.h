...
template <class FromType, size_t ScaleBits>
struct FixedToFloat
{
    static const bool identity = false;
...
struct NoWiden
{
    static const size_t initialWidth = N;
    static const size_t finalWidth = N;
};
...
{
    static const size_t initialWidth = N;
    static const size_t finalWidth = N+(N&1);
};
...
{
    static const size_t initialWidth = N;
    static const size_t finalWidth = 4;
};
...
// static const size_t finalSize: number of bytes per output vertex
// static void convertArray(const void *in, size_t stride, size_t n, void *out): convert an array of vertices. Input may be strided, but output will be unstrided.
...
struct VertexDataConverter
{
    ...
    static const size_t finalSize = WidenRule::finalWidth * sizeof(OutputType);
  ...
  private:
    static void copyComponent(OutputType *out, const InputType *in, size_t elementindex, OutputType defaultvalue)
    {
