...
const char* TypedArrayFindindexBuiltinsFromDSLAssembler::kBuiltinName() {
...
compiler::TNode<Number> TypedArrayFindindexBuiltinsFromDSLAssembler::FindIndexAllElements(compiler::TNode<Context> p_context, compiler::TNode<JSTypedArray> p_array, compiler::TNode<JSReceiver> p_callbackfn, compiler::TNode<Object> p_thisArg) {
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 14);
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 15);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 18);
  ...
  if (block13.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 21);
    ...
    ca_.Branch(tmp116, &block14, &block15, tmp99, tmp100, tmp101, tmp102, tmp103, tmp104, tmp105, tmp106, tmp107, tmp108, tmp115);
  }
  ...
  if (block14.is_used()) {
    ...
    ca_.Bind(&block14, &tmp117, &tmp118, &tmp119, &tmp120, &tmp121, &tmp122, &tmp123, &tmp124, &tmp125, &tmp126, &tmp127);
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 22);
    ca_.Goto(&block1, tmp117, tmp118, tmp119, tmp120, tmp125);
  }
  ...
  if (block15.is_used()) {
    ...
    ca_.Bind(&block15, &tmp128, &tmp129, &tmp130, &tmp131, &tmp132, &tmp133, &tmp134, &tmp135, &tmp136, &tmp137, &tmp138);
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 15);
    ca_.Goto(&block6, tmp128, tmp129, tmp130, tmp131, tmp132, tmp133, tmp134, tmp135, tmp136);
  }
  ...
  if (block6.is_used()) {
    ...
    ca_.Bind(&block6, &tmp139, &tmp140, &tmp141, &tmp142, &tmp143, &tmp144, &tmp145, &tmp146, &tmp147);
    compiler::TNode<Smi> tmp148;
    USE(tmp148);
    tmp148 = ca_.UncheckedCast<Smi>(BaseBuiltinsFromDSLAssembler(state_).FromConstexpr5ATSmi17ATconstexpr_int31(1));
    compiler::TNode<Smi> tmp149;
    USE(tmp149);
    tmp149 = ca_.UncheckedCast<Smi>(CodeStubAssembler(state_).SmiAdd(compiler::TNode<Smi>{tmp147}, compiler::TNode<Smi>{tmp148}));
    ca_.Goto(&block5, tmp139, tmp140, tmp141, tmp142, tmp143, tmp144, tmp145, tmp146, tmp149);
  }
  ...
  if (block4.is_used()) {
    ...
    ca_.Bind(&block4, &tmp150, &tmp151, &tmp152, &tmp153, &tmp154, &tmp155, &tmp156, &tmp157, &tmp158);
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 25);
    compiler::TNode<Number> tmp159;
    USE(tmp159);
    tmp159 = ca_.UncheckedCast<Number>(BaseBuiltinsFromDSLAssembler(state_).FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31(-1));
    ca_.Goto(&block1, tmp150, tmp151, tmp152, tmp153, tmp159);
  }
  ...
  if (block1.is_used()) {
    ...
    ca_.Bind(&block1, &tmp160, &tmp161, &tmp162, &tmp163, &tmp164);
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 10);
    ca_.Goto(&block16, tmp160, tmp161, tmp162, tmp163, tmp164);
  }
    ...
    ca_.Bind(&block16, &tmp165, &tmp166, &tmp167, &tmp168, &tmp169);
  return compiler::TNode<Number>{tmp169};
}
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 35);
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 40);
    ...
    USE(tmp36);
    tmp36 = ca_.UncheckedCast<Number>(TypedArrayFindindexBuiltinsFromDSLAssembler(state_).FindIndexAllElements(compiler::TNode<Context>{tmp28}, compiler::TNode<JSTypedArray>{tmp31}, compiler::TNode<JSReceiver>{tmp33}, compiler::TNode<Object>{tmp35}));
  ...
  if (block6.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 44);
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 47);
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp41}, MessageTemplate::kNotTypedArray, TypedArrayFindindexBuiltinsFromDSLAssembler(state_).kBuiltinName());
  }
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 50);
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp43}, MessageTemplate::kDetachedOperation, TypedArrayFindindexBuiltinsFromDSLAssembler(state_).kBuiltinName());
  }
}
