...
compiler::TNode<Number> TypedArrayFindindexBuiltinsFromDSLAssembler::FindIndexAllElements(compiler::TNode<Context> p_context, compiler::TNode<JSTypedArray> p_array, compiler::TNode<JSReceiver> p_callbackfn, compiler::TNode<Object> p_thisArg) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-findindex.tq", 13);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-findindex.tq", 14);
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-findindex.tq", 15);
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-findindex.tq", 17);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-findindex.tq", 18);
  ...
  if (block12.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-findindex.tq", 18);
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-findindex.tq", 20);
  ...
  if (block13.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-findindex.tq", 21);
  ...
  if (block14.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-findindex.tq", 22);
    ca_.Goto(&block1, tmp119, tmp120, tmp121, tmp122, tmp127);
  }
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-findindex.tq", 25);
    compiler::TNode<Number> tmp161;
    USE(tmp161);
    tmp161 = ca_.UncheckedCast<Number>(BaseBuiltinsFromDSLAssembler(state_).FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31(-1));
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-findindex.tq", 10);
  ...
  return compiler::TNode<Number>{tmp171};
}
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-findindex.tq", 35);
    compiler::TNode<JSTypedArray> tmp5;
    USE(tmp5);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-findindex.tq", 37);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-findindex.tq", 39);
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-findindex.tq", 40);
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-findindex.tq", 41);
    compiler::TNode<Number> tmp57;
    USE(tmp57);
    tmp57 = ca_.UncheckedCast<Number>(TypedArrayFindindexBuiltinsFromDSLAssembler(state_).FindIndexAllElements(compiler::TNode<Context>{tmp46}, compiler::TNode<JSTypedArray>{tmp52}, compiler::TNode<JSReceiver>{tmp54}, compiler::TNode<Object>{tmp56}));
  ...
  if (block6.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-findindex.tq", 44);
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-findindex.tq", 47);
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp65}, MessageTemplate::kNotTypedArray, TypedArrayFindindexBuiltinsFromDSLAssembler(state_).kBuiltinName());
  }
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-findindex.tq", 50);
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp70}, MessageTemplate::kDetachedOperation, TypedArrayFindindexBuiltinsFromDSLAssembler(state_).kBuiltinName());
  }
}
