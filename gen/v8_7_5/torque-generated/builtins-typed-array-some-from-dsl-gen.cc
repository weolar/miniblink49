...
const char* TypedArraySomeBuiltinsFromDSLAssembler::kBuiltinName() {
...
compiler::TNode<Oddball> TypedArraySomeBuiltinsFromDSLAssembler::SomeAllElements(compiler::TNode<Context> p_context, compiler::TNode<JSTypedArray> p_array, compiler::TNode<JSReceiver> p_callbackfn, compiler::TNode<Object> p_thisArg) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-some.tq", 13);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-some.tq", 14);
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-some.tq", 15);
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-some.tq", 17);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-some.tq", 18);
  ...
  if (block12.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-some.tq", 18);
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-some.tq", 20);
  ...
  if (block13.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-some.tq", 21);
    ...
    ca_.Branch(tmp118, &block14, &block15, tmp101, tmp102, tmp103, tmp104, tmp105, tmp106, tmp107, tmp108, tmp109, tmp110, tmp117);
  }
  ...
  if (block14.is_used()) {
    ...
    ca_.Bind(&block14, &tmp119, &tmp120, &tmp121, &tmp122, &tmp123, &tmp124, &tmp125, &tmp126, &tmp127, &tmp128, &tmp129);
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-some.tq", 22);
    compiler::TNode<Oddball> tmp130;
    USE(tmp130);
    tmp130 = BaseBuiltinsFromDSLAssembler(state_).True();
    ca_.Goto(&block1, tmp119, tmp120, tmp121, tmp122, tmp130);
  }
  ...
  if (block15.is_used()) {
    ...
    ca_.Bind(&block15, &tmp131, &tmp132, &tmp133, &tmp134, &tmp135, &tmp136, &tmp137, &tmp138, &tmp139, &tmp140, &tmp141);
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-some.tq", 15);
    ca_.Goto(&block6, tmp131, tmp132, tmp133, tmp134, tmp135, tmp136, tmp137, tmp138, tmp139);
  }
  ...
  if (block6.is_used()) {
    ...
    ca_.Bind(&block6, &tmp142, &tmp143, &tmp144, &tmp145, &tmp146, &tmp147, &tmp148, &tmp149, &tmp150);
    compiler::TNode<Smi> tmp151;
    USE(tmp151);
    tmp151 = ca_.UncheckedCast<Smi>(BaseBuiltinsFromDSLAssembler(state_).FromConstexpr5ATSmi17ATconstexpr_int31(1));
    compiler::TNode<Smi> tmp152;
    USE(tmp152);
    tmp152 = ca_.UncheckedCast<Smi>(CodeStubAssembler(state_).SmiAdd(compiler::TNode<Smi>{tmp150}, compiler::TNode<Smi>{tmp151}));
    ca_.Goto(&block5, tmp142, tmp143, tmp144, tmp145, tmp146, tmp147, tmp148, tmp149, tmp152);
  }
  ...
  if (block4.is_used()) {
    ...
    ca_.Bind(&block4, &tmp153, &tmp154, &tmp155, &tmp156, &tmp157, &tmp158, &tmp159, &tmp160, &tmp161);
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-some.tq", 25);
    compiler::TNode<Oddball> tmp162;
    USE(tmp162);
    tmp162 = BaseBuiltinsFromDSLAssembler(state_).False();
    ca_.Goto(&block1, tmp153, tmp154, tmp155, tmp156, tmp162);
  }
  ...
  if (block1.is_used()) {
    ...
    ca_.Bind(&block1, &tmp163, &tmp164, &tmp165, &tmp166, &tmp167);
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-some.tq", 10);
    ca_.Goto(&block16, tmp163, tmp164, tmp165, tmp166, tmp167);
  }
    ...
    ca_.Bind(&block16, &tmp168, &tmp169, &tmp170, &tmp171, &tmp172);
  return compiler::TNode<Oddball>{tmp172};
}
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-some.tq", 35);
    compiler::TNode<JSTypedArray> tmp5;
    USE(tmp5);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-some.tq", 37);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-some.tq", 39);
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-some.tq", 40);
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-some.tq", 41);
    compiler::TNode<Oddball> tmp57;
    USE(tmp57);
    tmp57 = ca_.UncheckedCast<Oddball>(TypedArraySomeBuiltinsFromDSLAssembler(state_).SomeAllElements(compiler::TNode<Context>{tmp46}, compiler::TNode<JSTypedArray>{tmp52}, compiler::TNode<JSReceiver>{tmp54}, compiler::TNode<Object>{tmp56}));
  ...
  if (block6.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-some.tq", 44);
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-some.tq", 47);
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp65}, MessageTemplate::kNotTypedArray, TypedArraySomeBuiltinsFromDSLAssembler(state_).kBuiltinName());
  }
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../v8/src/builtins/typed-array-some.tq", 50);
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp70}, MessageTemplate::kDetachedOperation, TypedArraySomeBuiltinsFromDSLAssembler(state_).kBuiltinName());
  }
}
