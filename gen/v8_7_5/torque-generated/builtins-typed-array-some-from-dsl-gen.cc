...
compiler::TNode<Oddball> TypedArraySomeBuiltinsFromDSLAssembler::SomeAllElements(compiler::TNode<Context> p_context, compiler::TNode<JSTypedArray> p_array, compiler::TNode<JSReceiver> p_callbackfn, compiler::TNode<Object> p_thisArg) {
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 14);
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 15);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 18);
  ...
  if (block13.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 21);
  ...
  if (block14.is_used()) {
    ...
    USE(tmp128);
    tmp128 = BaseBuiltinsFromDSLAssembler(state_).True();
    ca_.Goto(&block1, tmp117, tmp118, tmp119, tmp120, tmp128);
  }
  ...
  if (block15.is_used()) {
    ...
    ca_.Bind(&block15, &tmp129, &tmp130, &tmp131, &tmp132, &tmp133, &tmp134, &tmp135, &tmp136, &tmp137, &tmp138, &tmp139);
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 15);
    ca_.Goto(&block6, tmp129, tmp130, tmp131, tmp132, tmp133, tmp134, tmp135, tmp136, tmp137);
  }
  ...
  if (block6.is_used()) {
    ...
    ca_.Bind(&block6, &tmp140, &tmp141, &tmp142, &tmp143, &tmp144, &tmp145, &tmp146, &tmp147, &tmp148);
    compiler::TNode<Smi> tmp149;
    USE(tmp149);
    tmp149 = ca_.UncheckedCast<Smi>(BaseBuiltinsFromDSLAssembler(state_).FromConstexpr5ATSmi17ATconstexpr_int31(1));
    compiler::TNode<Smi> tmp150;
    USE(tmp150);
    tmp150 = ca_.UncheckedCast<Smi>(CodeStubAssembler(state_).SmiAdd(compiler::TNode<Smi>{tmp148}, compiler::TNode<Smi>{tmp149}));
    ca_.Goto(&block5, tmp140, tmp141, tmp142, tmp143, tmp144, tmp145, tmp146, tmp147, tmp150);
  }
  ...
  if (block4.is_used()) {
    ...
    ca_.Bind(&block4, &tmp151, &tmp152, &tmp153, &tmp154, &tmp155, &tmp156, &tmp157, &tmp158, &tmp159);
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 25);
    compiler::TNode<Oddball> tmp160;
    USE(tmp160);
    tmp160 = BaseBuiltinsFromDSLAssembler(state_).False();
    ca_.Goto(&block1, tmp151, tmp152, tmp153, tmp154, tmp160);
  }
  ...
  if (block1.is_used()) {
    ...
    ca_.Bind(&block1, &tmp161, &tmp162, &tmp163, &tmp164, &tmp165);
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 10);
    ca_.Goto(&block16, tmp161, tmp162, tmp163, tmp164, tmp165);
  }
    ...
    ca_.Bind(&block16, &tmp166, &tmp167, &tmp168, &tmp169, &tmp170);
  return compiler::TNode<Oddball>{tmp170};
}
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 35);
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 40);
    ...
    USE(tmp36);
    tmp36 = ca_.UncheckedCast<Oddball>(TypedArraySomeBuiltinsFromDSLAssembler(state_).SomeAllElements(compiler::TNode<Context>{tmp28}, compiler::TNode<JSTypedArray>{tmp31}, compiler::TNode<JSReceiver>{tmp33}, compiler::TNode<Object>{tmp35}));
  ...
  if (block6.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 44);
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 47);
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp41}, MessageTemplate::kNotTypedArray, TypedArraySomeBuiltinsFromDSLAssembler(state_).kBuiltinName());
  }
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 50);
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp43}, MessageTemplate::kDetachedOperation, TypedArraySomeBuiltinsFromDSLAssembler(state_).kBuiltinName());
  }
}
