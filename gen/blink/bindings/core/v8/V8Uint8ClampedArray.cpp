...
// This static member must be declared by DEFINE_WRAPPERTYPEINFO in DOMUint8ClampedArray.h.
...
DOMUint8ClampedArray* V8Uint8ClampedArray::toImpl(v8::Local<v8::Object> object)
{
    ...
    RefPtr<DOMUint8ClampedArray> typedArray = DOMUint8ClampedArray::create(V8ArrayBuffer::toImpl(v8View->Buffer()), v8View->ByteOffset(), v8View->Length());
...
{
    scriptWrappable->toImpl<DOMUint8ClampedArray>()->ref();
}

void V8Uint8ClampedArray::derefObject(ScriptWrappable* scriptWrappable)
{
    scriptWrappable->toImpl<DOMUint8ClampedArray>()->deref();
}
