#ifndef mc_LayerChangeAction_h
#define mc_LayerChangeAction_h
...
public:
    LayerChangeActionCreate(int64 actionId, int layerId, mc_blink::WebLayerImplClient::Type layerType);

    virtual void run(LayerTreeHost* host) override;
private:
    mc_blink::WebLayerImplClient::Type m_layerType;
};
