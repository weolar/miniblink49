...
#include "mc/raster/SkBitmapRefWrap.h"
...
#ifndef NDEBUG
DEFINE_DEBUG_ONLY_GLOBAL(WTF::RefCountedLeakCounter, layerChangeActionCounter, ("mcLayerChangeAction"));
#endif
...
LayerChangeActionCreate::LayerChangeActionCreate(int64 actionId, int layerId, mc_blink::WebLayerImplClient::Type layerType)
...
//     OutputDebugStringW(outString.charactersWithNullTermination().data());
    ...
    switch (m_layerType)
    {
    case mc_blink::WebLayerImplClient::LayerType:
        layer = new CompositingLayer(m_layerId);
        break;
    case mc_blink::WebLayerImplClient::ContentLayerType:
        layer = new CompositingLayer(m_layerId);
        break;
    case mc_blink::WebLayerImplClient::ScrollbarLayerType:
        layer = new CompositingLayer(m_layerId);
        break;
    case mc_blink::WebLayerImplClient::ImageLayerType:
...
void LayerChangeActionDrawPropUpdata::appendDirtyLayer(mc_blink::WebLayerImpl* layer)
{
...
//     OutputDebugStringW(outString.charactersWithNullTermination().data());
    ...
    if (CompositingLayer::ImageCCLayer != layer->mcType()) {
        ASSERT(false);
        return;
    }
