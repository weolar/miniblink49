...
#include "mc/blink/WebLayerImpl.h" // TODO for backgroundColor
...
#ifndef NDEBUG
DEFINE_DEBUG_ONLY_GLOBAL(WTF::RefCountedLeakCounter, tileCounter, ("mcTile"));
#endif
...
mc_blink::WebLayerImpl* Tile::layer() const
{
    if (!m_tileGrid)
        return nullptr;
