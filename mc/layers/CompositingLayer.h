#ifndef mc_LayerForCompositing_h
#define mc_LayerForCompositing_h
...
public:
    ...
    virtual CCType mcType() const { return NormalCCLayer; }
...
public:
    ...
    virtual CCType mcType() const override { return CompositingLayer::ImageCCLayer;    }
