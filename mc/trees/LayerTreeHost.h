#ifndef mc_LayerTreeHost_h
#define mc_LayerTreeHost_h
...
public:
    ...
    void registerLayer(mc_blink::WebLayerImpl* layer);
    void unregisterLayer(mc_blink::WebLayerImpl* layer);
    mc_blink::WebLayerImpl* getLayerById(int id);
    ...
    mc_blink::WebLayerImpl* getRootLayer() { return m_rootLayer; }
    const mc_blink::WebLayerImpl* getConstRootLayer() { return m_rootLayer; }

    void appendPendingRepaintRect(const SkRect& r);

    LayerAnimationController* getOrCreateAnimationController(int layerId);
    void removeAniController(int);
    bool activateAndUpdataAnimations(double monotonicTime);

    void attachLayer(mc_blink::WebCompositorAnimationPlayerImpl* player);
    void detachLayer(mc_blink::WebCompositorAnimationPlayerImpl* player);
    ...
    void notifyAnimationEvent(bool isStarted, double monotonicTime, int group);
...
private:
    ...
    mc_blink::WebLayerImpl* m_rootLayer;
    ...
    WTF::HashMap<int, mc_blink::WebLayerImpl*> m_liveLayers;
    WTF::HashMap<int, LayerAnimationController*> m_liveAniController;
    WTF::HashSet<mc_blink::WebCompositorAnimationPlayerImpl*> m_liveAniPlayers;
