...
#ifndef mc_WebLayerImpl_h
#define mc_WebLayerImpl_h
...
public:
    ...
    //explicit WebLayerImpl(scoped_refptr<mc::Layer>);
    ~WebLayerImpl() override;

    void setLayerTreeHost(mc::LayerTreeHost* host);
    mc::LayerTreeHost* layerTreeHost() const;
    ...
    void recordDrawChildren(mc::RasterTaskGroup* taskGroup, int deep);
    ...
    void setNonFastScrollableRegion(const blink::WebVector<blink::WebRect>& region) override;
    blink::WebVector<blink::WebRect> nonFastScrollableRegion() const override;
    void setTouchEventHandlerRegion(const blink::WebVector<blink::WebRect>& region) override;
    ...
    blink::WebVector<std::pair<int64_t, blink::WebRect>> frameTimingRequests() const override;
    ...
    mc::TileGrid* tileGrid() { return m_tileGrid; }
    ...
    mc::DrawProps* drawProperties();
    //mc::DrawToCanvasProperties* drawToCanvasProperties(); // 在上屏时使用本属性，和DrawProperties比，不一定是最新的坐标属性，需要光栅化后来更新
    void updataDrawToCanvasProperties(mc::DrawProps* prop);
...
protected:
    ...
    void appendLayerChangeAction(mc::LayerChangeAction* action);
    ...
    mc_blink::WebLayerImpl* m_scrollParent;
    //mc_blink::WebLayerImpl* m_clipParent;
    mc_blink::WebLayerImpl* m_maskLayer;
    mc_blink::WebLayerImpl* m_replicaLayer;
...
//     int m_replicaLayerId;
    ...
    mc::DrawProps* m_drawProperties;
    //mc::DrawToCanvasProperties* m_drawToCanvasProperties;

    WTF::Vector<mc::LayerChangeAction*> m_savedActionsWhenHostIsNull;
    bool m_hasMaskLayerChild;
    bool m_isMaskLayer;
    bool m_isReplicaLayer;

    mc_blink::WebFilterOperationsImpl* m_filterOperations;
